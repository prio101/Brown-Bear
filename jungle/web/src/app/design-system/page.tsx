...
/**
 * Token reference sheet (BB-102), kept at /design-system.
 *
 * Not a dashboard page and not linked from the nav. It exists so the token layer
 * stays visually verifiable in both modes — every type role, all eight series
 * slots, the status chips and the focus states on one screen. Cheaper to catch a
 * wrong token here than in a chart.
 *
 * BB-105 took over "/" with the real overview.
 */
